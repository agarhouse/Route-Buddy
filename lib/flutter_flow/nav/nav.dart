...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'SubmitRouteDetails',
          path: '/submitRouteDetails',
          requireAuth: true,
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'SubmitRouteDetails')
              : const SubmitRouteDetailsWidget(),
        ),
        FFRoute(
          name: 'Route',
          path: '/route',
          requireAuth: true,
          asyncParams: {
            'routesdets': getDoc(['routes'], RoutesRecord.fromSnapshot),
          },
          builder: (context, params) => RouteWidget(
            routesdets: params.getParam(
              'routesdets',
              ParamType.Document,
            ),
          ),
